    ...
    >
      <ConstrainedBox classNames="px-4 py-8 pt-16 z-20 items-center justify-center">
        <Column classNames="w-full items-center justify-center">
          ...
          <p className="text-sm/normal md:text-base/normal dark:text-[var(--textColorLight)] text-[var(--textColorLight)] max-w-4xl text-center">
            I'm a Frontend Developer with 2+ year of experience at Flynaut. Skilled in React.js, Next.js, Axios, Git, Tailwind CSS, and Figma, I build user-friendly and responsive websites. I am passionate about learning new technologies.
          </p>
        ...
        <div className="mt-12 lg:mt-16 w-full flex flex-col items-center">
          <p className="text-base/6 font-medium">Connect with me</p>
